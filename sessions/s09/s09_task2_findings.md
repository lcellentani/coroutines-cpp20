...
```
[1] Entering main...
[2] [ReadyAwaitable] await_ready: (true)
[3] [ReadyAwaitable] await_resume: (42)
[4] Result from custom awaitable: 42
[5] [DeferredAwaitable] await_ready: (false)
[6] [DeferredAwaitable] await_suspend: (suspending)
[7] [DeferredAwaitable] await_resume: resumed by DeferredAwaitable
[8] Message from custom awaitable: resumed by DeferredAwaitable
[9] Exiting main...
```